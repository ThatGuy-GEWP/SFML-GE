...
namespace SFML_GE.System
{
    ...
    /// <summary>
    /// Dictates what side the text is aligned too.
    /// </summary>
    public enum TextAlignment
    {
        /// <summary>
        /// Aligns each row of text to the left side of the bounds.
        /// </summary>
        Left,
        /// <summary>
        /// Aligns each row of text to the right side of the bounds.
        /// </summary>
        Right,
        /// <summary>
        /// Aligns each row of text to the center of the bounds.
        /// </summary>
        Center,
    }
