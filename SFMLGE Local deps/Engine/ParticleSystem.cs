...
namespace SFML_Game_Engine
{
    ...
    public class ParticleSystem : Component, IRenderable
    {
        ...
        public override void OnAdded(GameObject go)
        {
            particleSprite = project.GetResource<TextureResource>("DefaultSprite");
        }
        ...
        public void Draw(RenderTarget rt)
        {
            ...
            for (int i = 0; i < particles.Count; i++)
            {
                ...
                particle.realLifeTime -= deltaTime;

                particle.velocity -= particle.velocity * drag * deltaTime;
